<template>
  <div>
    <v-data-table :headers="headers" :items="items" class="elevation-1" dark hide-default-footer>
      ...
      <template v-slot:top>
        <v-toolbar flat dark>
          <v-toolbar-title>血管手術資訊列表</v-toolbar-title>
...
<script>
export default {
  name: "VascularSurgeryInformation",
  data() {
    return {
      dialog: false,
      headers: [
      ...
      items: [
        {
          title: "胸、腹主動脈瘤微創治療新趨勢-支架血管治療主動脈瘤-",
          link: "https://www.tsvs.org/teach_detail.php?id=8"
        },
        {
          title: "血管支架簡介-1",
          link: "https://www.tsvs.org/teach_detail.php?id=12"
        }
      ],
      editedIndex: -1,
      editedItem: {
