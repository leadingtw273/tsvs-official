<template>
  <div class="my-12 px-12">
    <v-data-table :headers="headers" :items="items" class="elevation-1" dark hide-default-footer>
      ...
      <template v-slot:top>
        <v-toolbar flat dark>
          <v-toolbar-title>秘書處公告列表</v-toolbar-title>
